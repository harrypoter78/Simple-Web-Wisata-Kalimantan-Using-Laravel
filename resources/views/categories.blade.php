      ...
      <div class="row row-cols-1 row-cols-sm-2 g-4">
        ...
        <div class="col">
          <div class="card shadow-sm d-flex justify-content-center">
            ...
            <img  src="https://source.unsplash.com/1200x500?nature,city" style="height: 430; color-img"  >
            <div class="card-img-overlay position-absolute text-exception"  >
              <p class="card-text "><a class="text-decoration-none text-white" href="/categories/{{ $category->slug }}" class="text-decoration-none "> {{ $category->name }}</a></p>
              <p class="card-text text-white ">KALIMANTAN</p>
            </div>
          </div>
        </div>
        @endforeach
