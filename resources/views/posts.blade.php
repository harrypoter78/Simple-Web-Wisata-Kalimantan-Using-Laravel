...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
  <div class="col-md-6 px-0" style="font-family: 'Mulish', sans-serif;">
    ...
    <p class="lead my-3" style="opacity: 70%;">{{ $posts[0]->excerpt }}</p>
    <p class="lead mb-0"><a href="/posts/{{ $posts[0]->slug }}" class="text-white fw-bold">Selengkapnya...</a></p>
  </div>
</div>


@else
  <p class="text-center fs-3" style="font-family: 'Mulish', sans-serif;"><a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none">No Post Found...</a></p>
@endif
  ...
  <div class="col-md-6">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="font-family: 'Mulish', sans-serif;">
      <div class="col p-4 d-flex flex-column position-static">
        ...
        <p class="mb-auto" style="opacity: 70%;">{{ $post->excerpt}}</p>
        <a href="/posts/{{ $post->slug }}" class="stretched-link pt-5">Selengkapnya...</a>
      </div>
